...
@section('title', 'Register - Community Booking')
            ...
            <div class="rounded-md shadow-sm space-y-4">
                ...
                <div>
                    ...
                    <input id="phone_number" name="phone_number" type="tel" required 
                           ...
                           class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('phone_number') border-red-500 @enderror" 
