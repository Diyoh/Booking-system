...
@section('title', 'Login - Community Booking')
        ...
        <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <div x-data="{ show: false }" class="relative">
                    ...
                    <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-500 z-20">
